...
<body class="hideScroll">
	<form:form id="inputForm" modelAttribute="armyTree" action="${ctx}/rzzk/armyTree/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
			<tr>
				...
				<td class="width-35">
					<sys:treeselect id="parent" name="parent.id" value="${armyTree.parent.id}" labelName="parent.name" labelValue="${armyTree.parent.name}"
						title="父级编号" url="/rzzk/armyTree/treeData" extId="${armyTree.id}" cssClass="form-control " allowClear="true"/>
				</td>
			</tr>
			<tr>
