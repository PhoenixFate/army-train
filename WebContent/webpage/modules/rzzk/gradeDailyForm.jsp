...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="gradeDaily" action="${ctx}/rzzk/gradeDaily/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<sys:gridselect url="${ctx}/rzzk/gradeDaily/selecttrainee" id="trainee" name="trainee.id"  value="${gradeDaily.trainee.id}"  title="选择学员" labelName="trainee.name" 
				...
				<tr>
					...
					<td class="width-35">
						<sys:gridselect url="${ctx}/rzzk/gradeDaily/selecttrainItem" id="trainItem" name="trainItem.id"  value="${gradeDaily.trainItem.id}"  title="选择训练科目" labelName="trainItem.name" 
