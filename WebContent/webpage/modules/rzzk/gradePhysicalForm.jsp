...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="gradePhysical" action="${ctx}/rzzk/gradePhysical/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<sys:gridselect url="${ctx}/rzzk/gradePhysical/selecttrainee" id="trainee" name="trainee.id"  value="${gradePhysical.trainee.id}"  title="选择学员" labelName="trainee.name" 
				...
				<tr>
					...
					<td class="width-35">
						<sys:gridselect url="${ctx}/rzzk/gradePhysical/selecttrainPhysical" id="trainPhysical" name="trainPhysical.id"  value="${gradePhysical.trainPhysical.id}"  title="选择体能训练项" labelName="trainPhysical.name" 
